...
public class RegistrationServiceImpl {
    ...
    public String register(UserRegistrationDTO customerRegistrationDTO) {
        String token = customerService.signUp(
                new Customer(
    ...
    public String register(UserRegistrationDTO expertRegistrationDTO, byte[] expertPicture) {
        PictureValidator.isValidImageSize(expertPicture);

        String token = expertService.signUp(
                new Expert(
                        expertRegistrationDTO.getFirstname(),
                        expertRegistrationDTO.getLastname(),
                        expertRegistrationDTO.getEmail(),
                        expertRegistrationDTO.getUsername(),
                        expertRegistrationDTO.getPassword(),
                        expertPicture
                )
        );
    ...
    public String confirmToken(String token) {
        ...
        accountService.enableAppUser(
                confirmationToken.getAccount().getEmail(), confirmationToken.getAccount().getRole());
        return "confirmed";
    }
